...
public class DeleteForXFrame {
    JFrame jf = new JFrame("按照学号删除学生信息");
    ...
    public void jbtLister(){
        jbtQuery.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    studentInfo = Function.queryForStudenInfoFunction(Integer.parseInt(textNUm));
        ...
        jbD.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String num = jtfQueryNum.getText();
                try {
                    if(num!=""){
                        Function.deleteForStudentInfoFunction(Integer.parseInt(num));
