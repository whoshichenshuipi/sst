...
public class QueryBANJIFrame {
    StudentInfo studentInfo = null;
    JFrame QueryBANJIFrame = new JFrame("按照班级查询");
    ...
    Users users = null;
    public QueryBANJIFrame(Users users){
        this.users = users;
    }
    ...
    public void init() {
        ...
        QueryBANJIFrame.add(vbox);
        QueryBANJIFrame.setSize(600, 400);
        QueryBANJIFrame.setVisible(true);
        QueryBANJIFrame.setLocationRelativeTo(null);
    }
        ...
        jbtQuery.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (studentInfo != null){
                        JOptionPane.showMessageDialog(QueryBANJIFrame,"查询成功","消息对话框",JOptionPane.INFORMATION_MESSAGE);
                        queryFlash();
                        jtfQueryNum.setText("");
                    }else {
                        JOptionPane.showMessageDialog(QueryBANJIFrame,"查询失败","消息对话框",JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }
        });

        QueryBANJIFrame.addWindowListener(new WindowAdapter() {
            @Override
            public void windowClosing(WindowEvent e) {
                QueryBANJIFrame.setVisible(false);
            }
        });
