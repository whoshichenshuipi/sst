...
public class DeleteForBXFrame {
    JFrame jf = new JFrame("按照西部删除学生信息");

    JPanel jpQuery = new JPanel();
    JLabel jlbQueryNum = new JLabel("西部");
    ...
    public void jbtLister(){
        ...
        jbD.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    if(num!=""){
                        Function.deleteForStudentInfoXIBUFunction(num);
